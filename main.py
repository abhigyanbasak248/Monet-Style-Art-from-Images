...
from dataloader import ImageDataset, get_transforms
...
monet_dir = '/Users/asmitabasak/Downloads/gan-getting-started/monet_jpg/'
photo_dir = '/Users/asmitabasak/Downloads/gan-getting-started/photo_jpg/'
...
for i in range(5):
    ...
    ax[i, 0].axis("off")
    ax[i, 1].axis("off")
plt.savefig('/Users/asmitabasak/Desktop/GitHub/GAN/pic_to_paint.png')